...
npx convex env set REGISTRATION_ALLOW_LOCAL_DEV_ORIGINS true
```
...
3. Set Convex deployment vars: `SITE_URL`, `REGISTRATION_ALLOWED_ORIGINS`, SMTP, JWT keys. Do **not** set `REGISTRATION_ALLOW_LOCAL_DEV_ORIGINS` on production.
